...
public class GestorJSONTest { // Cubre ListaAdapter tambien
    ...
    private static final String RUTA_CONFIG_TEST = "src/main/resources/Config_partidaTest.json";
    private static final String RUTA_PARTIDA_TEST = "src/main/resources/test_partida_guardada.json";
    ...
    public void testCargarConfigDiferentesMapas() throws IOException {
        MotorJuego motorEasy = gestor.cargarConfig("src/main/resources/niveles/Dungeon_Easy.json");
