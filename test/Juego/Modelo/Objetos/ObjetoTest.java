...
public class ObjetoTest {
    ...
    public void testGetNombre() {
        ...
        assertEquals("Llave oxidada", llave.getNombre());
    }
    ...
    public void testGetDesc() {
        ...
        assertEquals("Abre puertas cerradas", llave.getDesc());
    }
    ...
    public void testLlaveUsar() {
        ...
        // La llave no modifica atributos
    ...
    @Test
    public void testLlaveEsLlave() {
        assertTrue(llave instanceof Objeto);
    }

    @Test
    public void testLlaveNoEsEquipableNiConsumible() {
        assertFalse(llave.esEquipable());
        assertFalse(llave.esConsumible());
    }
    ...
    @Test
    public void testUsarPocionEnJugadorMuerto() {
        jugador.takeDmg(100);
        assertFalse(jugador.estaVivo());

        pocion.usar(jugador);
        // La poción no debería revivir al jugador
        assertFalse(jugador.estaVivo());
    }
