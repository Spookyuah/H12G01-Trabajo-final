...
public class EnemigoTest {
    ...
    @Test
    public void testTakeDmgNegativo() {
        // No debería curar, se queda en 0 como mínimo
        goblin.takeDmg(-10);
        assertEquals(30, goblin.getVida()); // Math.max(0, 30 - (-10)) = Math.max(0, 40) = 40
        // Depende de la implementación: si queréis que no cure, poned Math.max(0, vida - Math.max(0, dmg))
    }
