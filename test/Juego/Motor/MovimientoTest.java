...
public class MovimientoTest {
    ...
    @Test
    public void testBuscarCercanoNormal() {
        Lista<Posicion> disponibles = new Lista<>();
        disponibles.add(new Posicion(0, 0));
        disponibles.add(new Posicion(0, 1));
        disponibles.add(new Posicion(0, 2));

        Posicion objetivo = new Posicion(0, 1);
        Posicion cercana = Movimiento.buscarCercano(disponibles, objetivo);

        assertEquals(new Posicion(0, 1), cercana);
    }
