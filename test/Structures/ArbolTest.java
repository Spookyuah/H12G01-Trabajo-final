...
public class ArbolTest {
    ...
    @Test
    public void testArbolEnteros() {
        Arbol<Integer> arbolInt = new Arbol<>();
        arbolInt.setRaiz(1);
        arbolInt.addHijo(1, 2);
        arbolInt.addHijo(1, 3);
        arbolInt.addHijo(2, 4);

        assertEquals(4, arbolInt.getNumNodos());
        assertEquals(3, arbolInt.getHojas().size()); // 3, 4
        assertEquals(2, arbolInt.altura());
        assertEquals(2, arbolInt.profundidad(4));
    }
